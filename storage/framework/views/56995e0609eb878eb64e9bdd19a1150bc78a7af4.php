        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="<?php echo e(url('/admin/wisatas/create')); ?>" class="btn btn-success btn-sm" title="Add New wisata">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="<?php echo e(url('/admin/wisatas')); ?>" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search" enctype="multipart/form-data">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> <?php echo $wisatas->appends(['search' => Request::get('search')])->render(); ?> </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bismillah\resources\views/admin/wisatas/index.blade.php ENDPATH**/ ?>